...
A profileplyr object that has been annotated with GREAT is loaded below and the annotations can be seen in the range metadata. Just one line of code was required to make this object: anno_great = annotateRanges_great(proplyrObject, species = "mm10")
...
data("annotated_object")
colnames(mcols(annotated_object))

generateEnrichedHeatmap(annotated_object,
